...
3.  Create a 16 digit app password of your gmail account using the following link: (https://myaccount.google.com/apppasswords). This information is confidential and not to be share with anyone.
